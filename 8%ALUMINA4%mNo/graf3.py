...
def draw_triangle(ax):
    ...
    # Axis labels
    ax.text(-0.02, -0.03, "MgO 48-58", ha="left", va="top", fontsize=10)
    ax.text(1.02, -0.03, "FeO 48-58", ha="right", va="top", fontsize=10)
    ax.text(0.5, h + 0.03, "SiO2 48-58", ha="center", va="bottom", fontsize=10)
